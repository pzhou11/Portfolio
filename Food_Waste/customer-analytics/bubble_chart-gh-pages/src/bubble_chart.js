...
var data = [
    ...
    'We want to empower you with information so that you as a consumer can make informed decisions.',
    'More data you provide on your consumption and waste patters, the better we can personalize to your need',
    'Click to Begin!!'
    ];

d3.select('svg').on("mouseover", function() {trans();} );
...
function bubbleChart() {
  ...
  function createNodes(rawData) {
    ...
    var myNodes = rawData.map(function (d) {
      return {
        id: d.id,
        radius: radiusScale(+d.total_amount*0.9),
  ...
  var chart = function chart(selector, rawData) {
    ...
    bubbles.enter() //.append("g")  //.append("g")//.classed('bubble', true)
...
/*
  ...
  function showDetail(d) {
    ...
    var content = '<span class="name">Title: </span><span class="value">' +
                  d.name +
                  '</span><br/>' +
                  '<span class="name">Dollar Waste Amount: </span><span class="value">$' +
                  addCommas(d.value) +
                  '</span><br/>' +
                  '<span class="name">Bill ID: </span><span class="value">' +
                  d.year +
                  '</span>';
